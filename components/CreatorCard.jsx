...
const CreatorCard = ({ rank, creatorImage, creatorName, creatorEths }) => (
    <div className="min-w-190 min-lg:min-w-240 dark:bg-nft-black-3 bg-white border dark:border-nft-black-1 border-nft-gray-1 rounded-3xl flex flex-col p-4 m-4">
